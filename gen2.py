...
class DG2(tf.keras.utils.Sequence):
    ...
    def __init__(self, _n_ts, _n_feat, obj, _skip,batch_size=16, n_scans_use =1, type="reg", _modes=None, _start=0, scale_file="post/minmax2.pkl", _timebloc = None, _shuffle = False):
        self.n_ts = _n_ts
        self.n_feat = _n_feat
        self.bs = batch_size
        self.dataobj = obj
    ...
    def __getitem__(self, index):
        ...
        if(self.load_type == "denac2"):
            ...
            X_clean[:,:,0] = (pd.read_csv("C:/Users/HP/Desktop/ANL/DS2avgs/" + str(mode) + ".csv", header=None,usecols=bunches).values.T)
