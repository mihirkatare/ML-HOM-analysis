...
class DataGenerator(tf.keras.utils.Sequence):
    ...
    def __init__(self, _n_ts, _n_feat, obj, _skip,batch_size=16, n_scans_use =1, type="reg", _modes=None, _start=0, scale_file="post/minmax.pkl", _timebloc = None, _shuffle = False, indices_diff = None):
